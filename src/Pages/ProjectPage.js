...
import ProjectAdelHafri from "../Componenets/ProjectAdelHafri";
      ...
      <div className="flex flex-row w-full relative bg-gradient-to-r from-blueM via-blueM to-pink-900 ">
        ...
        >
          <motion.button
            ...
            className="absolute -ml-[5px] py-[5px] text-center -right-[30px]  h-[100px] w-[60px] rounded-[20%] text-[30px] text-blueM  bg-greenM  text-center xlg:hidden"
          >
        ...
        <motion.div
          animate={{ x: drag }}
          transition={{ duration: 0.3 }}
          className="flex flex-col w-[310px] bg-blueM z-[40] xlg:w-[23%] h-[100vh] items-center  fixed h-[100vh] p-[30px] border-r-[10px]  lg:overflow-y-hidden space-y-[20px] border-greenM "
        >
          <h1 className="font-secondary text-transparent  bg-clip-text font-extrabold bg-gradient-to-r from-greenM to-pink-600  text-center font-bold text-[25px] lg:text-[30px] xl:text-[35px] ">
            Projects
          </h1>
          <ProjectThumbnail
            Page={"Adel"}
        ...
        >
          {page == "Adel" ? <ProjectAdelHafri></ProjectAdelHafri> : null}
